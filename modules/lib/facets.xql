...
declare variable $sf:sortFields := map { "fields": ("title", "author","titleSyriac","titleArabic","titleFrench","titleTransliteration") };
    ...
    <index xmlns="http://exist-db.org/collection-config/1.0" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:srophe="https://srophe.app">
        <lucene diacritics="no">
            ...
            return 
                ...
                <field name="titleFrench" expression="sf:field(descendant-or-self::tei:body, 'titleFrench')"/>
                <field name="titleTransliteration" expression="sf:field(descendant-or-self::tei:body, 'titleTransliteration')"/>
            </text>
